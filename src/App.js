...
class App extends Component {
  ...
  publishDataRange(dataRange) {
    this.setState({ dataRange: dataRange, dirty: false });
  }
        ...
        <div id="graph-container">
          ...
          <div id="statistics-column">
            ...
            <ul className="instructions">
              <li>
                Drag the points or the slider on the left to customize the
                graph.
              </li>
            ...
            />
            <p className="blurb">
              * This chart uses U.S. Census Data to calculate Federal Tax
              Revenue. This chart assumes single filing. Clinton's tax plan is
              offered in a truncated version for easier comparisons to other tax
              plans.
            </p>
          </div>
        </div>
    ...
    return (
      <div className="form-group data-selector-container">
        ...
        >
          ...
          <option value="ClintonTaxPlanTruncated.tsv">
            Clinton (truncated)
          </option>
      ...
      return (
        <div className="container">
          <div className="income-element">
            <label className="form-label income-element">
              Enter Your Income
            </label>
            <input
              type="range"
          ...
          <table className="table table-striped table-hover">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ${this.formatMonetaryOutput(this.amtTaxes(this.state.income))}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  Tax for Income of $16,000{" "}
                  <small>(family of 2 in poverty)</small>
                </td>
  ...
  render() {
    return (
      <div>
        ...
        <GraphAxes s={this.state.s} dataRange={this.props.dataRange} />
        <GraphPoints
          s={this.state.s}
...
class GraphPoints extends Component {
  render() {
    ...
    svg
      ...
      .attr("cx", function(d) {
        return x(d["Tax Bracket"]) + margin.left;
      })
      .attr("cy", function(d) {
        return y(d["Tax Rate"]) + margin.top;
      });
      ...
      d3
        ...
        .on("drag", function(d) {
          ...
          if (i !== 0 && i !== data.length - 1) {
            ...
            var newXVal =
              ((cx - margin.left) * dataRange.xMax) / areaDims.width;
          ...
          var newYVal =
            ((areaDims.height - (cy - margin.top)) * dataRange.yMax) /
            areaDims.height;
          if (newYVal < 0) {
            data[i]["Tax Rate"] = 0;
          } else if (newYVal > 100) {
